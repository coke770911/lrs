<div class="container">
    ...
    <form class="form-horizontal" id="formData" method="post" action="#">
        ...
        <div class="form-group">
            <label class="col-sm-2 control-label">是否上架考試</label>
            <div class="col-sm-10">
                <label class="checkbox-inline">
                    <input type="radio" name="rg_is_del" value="0" <?php echo $rg['rg_is_del'] == "0" ? "checked": "" ; ?> >上架
                </label>
                <label class="checkbox-inline">
                    <input type="radio" name="rg_is_del" value="1" <?php echo $rg['rg_is_del'] == "0" ? "" : "checked" ; ?> >下架
                </label>
            </div>
        </div>
        <div class="form-group">
