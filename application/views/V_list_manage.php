    ...
    <table class="table table-striped">
        <thead>
            <tr>
                ...
                <th class="text-center" style="width: 7%;">目前報名人數</th>
                <th class="text-center" style="width: 7%;">考照人數限制</th>
        ...
        <?php 
            if(count($list) > 0 ) {
                ...
                foreach($list as $row) {
                    ...
                    echo "<a class='btn btn-default btn_apply' style='margin-left: 5px;margin-right: 5px;' href='/lrs/Manage/checkList/".$row['rg_id']."'>報名資料</a>";
